...
var availMode = ["TV", "AV", "P"];
var availAperture = ["3.6", "4.2", "6.4", "8"];
var availShutter = ["1/20", "1/60", "1/200", "1/800"];
var availISO = ["100", "200", "400", "800", "1600"];
...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .selMode').click(function () {
            $("#nav_title").text("Mode");   
            generateSettingHTML(availMode, 1);
console.log("selected mode settings");
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .selAperture').click(function () {
            ...
            generateSettingHTML(availAperture, 1);
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .selShutter').click(function () {
            ...
            generateSettingHTML(availShutter, 1);
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .selISO').click(function () {
            $("#nav_title").text("ISO");   
            generateSettingHTML(availISO, 1);

            wrapperChat.addClass("page-quick-sidebar-content-item-shown");
        });

        wrapper.find('.page-quick-sidebar-chat-user .media-list > .sel_val').click(function () {
        ...
        var generateSettingHTML = function(options, current) {
            var htmlResult = "";
            for (i = 0; i < options.length; i++) {
                if (current != i) {
                    htmlResult +="<li class=\"media sel_val\" value=\"" + options[i] + "\"><div class=\"media-body\"><h4 class=\"media-heading\">" + options[i] + "</h4></div></li>";
                } else {
                   htmlResult +="<li class=\"media sel_val\" value=\"" + options[i] + "\"><div class=\"media-body\"><h4 class=\"media-heading\">" + options[i] + "</h4><div class=\"media-heading-sub\"> Current </div></div></li>"; 
                }
